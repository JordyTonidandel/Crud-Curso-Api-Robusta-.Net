...
namespace Manager.API.ViewModels
{
  ...
  {
    [Required(ErrorMessage = "The Id can't be empty")]
    [MinLength(1, ErrorMessage = "Min Lenght of the name should be 1 characters")]
    ...
    [MinLength(3, ErrorMessage = "Min Lenght of the name should be 3 characters")]
